...
@Controller
@RequestMapping("/stock-visual")
public class StockVisualController {

    private final StockService stockService;

    public StockVisualController(StockService stockService) {
    ...
    public String filterData(
        ...
        return String.format("redirect:/stock-visual?company=%s&dateFrom=%s&dateTo=%s",company, dateFrom, dateTo);
    }
